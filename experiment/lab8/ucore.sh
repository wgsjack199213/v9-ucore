...
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/hello.c ucore/user/bin/hello.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/forktree.c ucore/user/bin/forktree.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/faultreadkernel.c ucore/user/bin/faultreadkernel.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/faultread.c ucore/user/bin/faultread.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/exit.c ucore/user/bin/exit.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/divzero.c ucore/user/bin/divzero.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/badarg.c ucore/user/bin/badarg.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/pgdir.c ucore/user/bin/pgdir.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/matrix.c ucore/user/bin/matrix.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/spin.c ucore/user/bin/spin.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/waitkill.c ucore/user/bin/waitkill.c
cpp-5  -Iucore/user/libs -Iucore/lib -Iucore/kern/include ucore/user/yield.c ucore/user/bin/yield.c
